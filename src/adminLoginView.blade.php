...
<html>
  ...
  <section class="material-half-bg">
    ...
    <script type="text/javascript" src="miniorange/sso/includes/js/plugins/bootstrap-notify.min.js"></script>
    <script type="text/javascript" src="miniorange/sso/includes/js/plugins/sweetalert.min.js"></script>
    <?php
