              ...
              <div class="tile">
                <div class="row">
                  <div class="col-lg-10">
                    ...
                    <img src="miniorange/sso/resources/images/setup_1.png" style="width:800px;height:380px;margin-left:50px; border:1px solid;"> 
                    <br/><br/>
                    <h4>Step 2:</h4>
                    <ul>
                    ...
                    <img src="miniorange/sso/resources/images/setup_2.png" style="width:800px;height:380px;margin-left:50px; border:1px solid;">
                    <br/><br/>
                    <h4>Step 3:</h4>
                    <ul>
                    <li>You can test if the plugin configured properly or not by clicking  on the <b>Test Configuration</b> button.</li>
                    </ul>
                    <img src="miniorange/sso/resources/images/setup_3.png" style="width:800px;height:380px;margin-left:50px; border:1px solid;">
                    <ul>
                    <br/>
                    <li>If the configuration is correct, you should see a Test Successful screen with the user's attribute values.</li>
                    </ul>
                    <img src="miniorange/sso/resources/images/setup_4.png" style="width:600px;height:400px;margin-left:50px; border:1px solid;">
                    <br/><br/>
                    <h4>Step 4:</h4>
